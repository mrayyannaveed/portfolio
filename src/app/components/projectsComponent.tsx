...
const ProjectsComponent = (props:any) => {
  return (
    <div className='mb-5'>
        <section className={`text-white hover:scale-110 duration-700 w-[95%] mx-auto lg:w-[90%] mb-5 flex flex-col items-center rounded-2xl gap-3 text-center min-h-[50vh] md:min-h-[60vh] bg-slate-700 ${props.bg} `}>
